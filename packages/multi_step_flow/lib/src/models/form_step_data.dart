...
class FormStepData {
  ...
  factory FormStepData.fromJson(Map<String, dynamic> json) => FormStepData(
    ...
    touchedFields: Set<String>.from((json['touchedFields'] ?? []).cast<String>()),
    validFields: Set<String>.from((json['validFields'] ?? []).cast<String>()),
    fieldErrors: Map<String, String>.from((json['fieldErrors'] ?? {}).map(
  ...
  FormStepData updateField(String fieldName, dynamic value) {
    ...
    final updatedTouchedFields = Set<String>.from(touchedFields)..add(fieldName);
