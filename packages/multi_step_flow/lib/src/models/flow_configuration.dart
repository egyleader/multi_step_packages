...
class FlowConfiguration {
  ...
  FlowConfiguration copyWith({
    ...
    return FlowConfiguration(
      ...
      skipValidationForOptionalSteps: skipValidationForOptionalSteps ?? this.skipValidationForOptionalSteps,
  ...
  factory FlowConfiguration.fromJson(Map<String, dynamic> json) {
    return FlowConfiguration(
      ...
      autoAdvanceOnValidation: json['autoAdvanceOnValidation'] as bool? ?? false,
      skipValidationForOptionalSteps: json['skipValidationForOptionalSteps'] as bool? ?? true,
      allowSkipAll: json['allowSkipAll'] as bool? ?? false,
      defaultStepDuration: json['defaultStepDuration'] != null
  ...
  bool operator ==(Object other) {
    ...
    return other is FlowConfiguration &&
        ...
        other.skipValidationForOptionalSteps == skipValidationForOptionalSteps &&
